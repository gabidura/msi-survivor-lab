#!/usr/bin/env python3
"""
MSI Survivor Lab v05 Pattern Search
====================
...
if tk is not None:
    class SurvivorLabApp(tk.Tk):
        def __init__(self):
            super().__init__()
            self.title("MSI Survivor Lab v05 Pattern Search - Local, Global, and Windowed Envelopes")
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="MSI Survivor Lab v05 Pattern Search")

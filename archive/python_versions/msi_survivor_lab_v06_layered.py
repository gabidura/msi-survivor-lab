#!/usr/bin/env python3
"""
MSI Survivor Lab v06 Layered Exhaustion
====================
...
Run GUI:
    python msi_survivor_lab_v04_validation.py

Run tests:
    python msi_survivor_lab_v04_validation.py --self-test
...
if tk is not None:
    class SurvivorLabApp(tk.Tk):
        def __init__(self):
            super().__init__()
            self.title("MSI Survivor Lab v06 Layered Exhaustion - Local, Global, and Windowed Envelopes")
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="MSI Survivor Lab v06 Layered Exhaustion")

#!/usr/bin/env python3
"""
MSI Survivor Lab v08 Polynomial / Boundary / Multi-Layer Laboratory
====================================================================
...
Run GUI:
    python msi_survivor_lab_v08_polynomial.py

Run tests:
    python msi_survivor_lab_v08_polynomial.py --self-test

Example polynomial-law report:
    python msi_survivor_lab_v08_polynomial.py --poly-law --H 0 --z 5 --n 58 --start 0 --stop 59
...
if tk is not None:
    class SurvivorLabApp(tk.Tk):
        def __init__(self):
            super().__init__()
            self.title("MSI Survivor Lab v08 Polynomial / Boundary / Multi-Layer - Local, Global, Windowed")
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="MSI Survivor Lab v08 Polynomial / Boundary / Multi-Layer Laboratory")
